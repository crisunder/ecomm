...
<body>
	...
	<br>
	<div class="aboutus" style="position: relative; text-align: center; z-index: -2;">
		<p class="1st" style="width: 600px; color: black; font-size: 40px; margin-top: 300px; margin-left:34.5vw;">
			Takip Ulo strives to give the customers the quality of helmet they deserve and help them be confident to face the road with a good headstart.
		</p>
	</div>
<br><br><br><br><br><br>
<div class="footer">
