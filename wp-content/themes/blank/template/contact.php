...
<body>
	...
	<div class="nav">
		...
		<div class="home">
		<a href="http://localhost/wordpress/wp-content/themes/blank/template/index.php" class="homebtn">HOME</a>
		</div>
		<div class="dropdown">
			<div class="category">
		...
		<div class="dropdown3">
			<div class="aboutus">
				...
				<div class="aboutdropdown-contents">
					<a href="http://localhost/wordpress/wp-content/themes/blank/template/aboutus.php">COMPANY INFO</a>
	...
	<br>
	<div class="contact" style="position: relative; text-align: center; z-index: -2;">
		<p class="2nd" style="width: 600px; color: black; font-size: 45px; margin-top: 300px; margin-left:34.5vw; font-weight: bold;">
			CONTACT US
		</p>
		<p style="width: 600px; color: black; font-size: 42px; margin-top: 40px; margin-left:34.5vw;">
			TAKIP ULO MAIN OFFICE:
		</p>
		<p style="width: 1000px; color: black; font-size: 30px; margin-top: 10px; margin-left:23.5vw;">
			BLOCK 2, LOT 28, PHASE A GREENGATE HOMES, MALAGASANG 2-E, IMUS, CAVITE
		</p>
		<P style="width: 600px; color: black; font-size: 42px; margin-top: 60px; margin-left:34.5vw;">
			LAGUNA SALES OFFICE:
		</P>
		<p style="width: 1000px; color: black; font-size: 30px; margin-top: 10px; margin-left:23.5vw;">
			PAG-ASA 2 059 LAGUNA CITY
		</p>
		<p style="width: 1000px; color: black; font-size: 30px; margin-top: 10px; margin-left:23.5vw;">
			TELEPHONE NO.: 564-7815
		</p>
